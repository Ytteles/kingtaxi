...
<?php 
    ...
    $order = "`order_id`,`order_data`, `locationIn`, `locationOut`, `user_number` ORDER BY `order_id`";
    $sql = "SELECT `order_data`, `locationIn`, `locationOut`, `class_taxi` FROM `order`, `users` WHERE `id` = {$_SESSION['user_id']}  AND `user_number` = {$_SESSION['user_id']} AND {$dateCond} AND {$classTaxi}  GROUP BY  {$order} DESC;";
...
<body class="feedback__body">
    ...
    <header class="head__fed">
        <nav class="header__nav">
            ...
            <li class="menu__item"><a href="./feedback.html#user__info" class="menu__link"></a></li>
            <li class="menu__item"><a href="./feedback.html#driver__info" class="menu__link"></a></li>
            <li class="menu__item"><a href="./feedback.html#business__info" class="menu__link"></a></li>
    ...
    <div>
        ...
        <form action="usercab.php" methode="GET">
